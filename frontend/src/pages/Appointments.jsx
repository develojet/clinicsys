...
const Appointments = () => {
  ...
  const [appointments, setAppointments] = useState([
    ...
    {
      id: 1030,
      patient: "Sisa Gonzales",
      type: "Referral",
      time: "04:00 PM",
      date: "2026-05-01",
      complaint: "Specialist referral",
    },
  ]);
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            Manage patient bookings and clinical entries.
          </p>
        </div>
        <button
            ...
            <div className="relative">
              ...
              {(() => {
                ...
                switch (selectedAppointment.type) {
                  case "Opta":
                    return <OptaConsultDetails {...props} />;
                  case "Follow-up":
                    return <FollowupConsultDetails {...props} />;
                  case "ENT":
                    return <ENTConsultDetails {...props} />;
                  case "Medicine":
                    return <MedicineConsultDetails {...props} />;
                  case "OB":
                    return <OBConsultDetails {...props} />;
                  case "Pedia":
                    return <PediaConsultDetails {...props} />;
                  case "Referral":
                    return <ReferralConsultDetails {...props} />;
                  default:
                    return (
                      <div className="bg-white p-20 rounded-[2.5rem] text-center border border-slate-100 shadow-xl">
                        <p className="text-slate-400 font-black uppercase tracking-widest text-[10px]">
                          Clinical Form for {selectedAppointment.type} coming
                          soon
                        </p>
                      </div>
                    );
