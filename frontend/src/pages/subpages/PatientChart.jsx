  ...
  const [consultations] = useState([
    {
      ...
      date: "2026-04-12",
      type: "Referral",
      complaint: "Inter-departmental Referral",
      doctor: "Dr. De Castro",
    },
    {
      id: 702,
    ...
    },
    {
      ...
      date: "2026-03-28",
      type: "Opta",
      complaint: "Blurring of Vision (OD)",
      doctor: "Dr. Reyes",
    },
    {
      id: 882,
    ...
    },
    {
      ...
      date: "2026-03-15",
      type: "OB-GYN",
      complaint: "Routine Prenatal (32 weeks)",
      doctor: "Dr. Filipino",
    },
    {
      id: 302,
      date: "2026-03-10",
      type: "Pedia",
      complaint: "Routine Growth Check-up",
      doctor: "Dr. Santos",
    },
    {
      id: 405,
      date: "2026-02-17",
      type: "ENT",
      complaint: "Epistaxis & Sore Throat",
      doctor: "Dr. Ponsaran",
    },
  ]);
          ...
          {consultations.map((c) => (
            ...
            >
              <div className="flex gap-12 items-center">
                ...
                <span
                  className={`px-2.5 py-1 rounded text-[9px] font-black uppercase tracking-widest border ${getTagStyles(c.type)}`}
                >
                  {c.type}
                </span>
      ...
      <div className="mt-8">
        {!selectedVisit ? (
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            {selectedVisit.type === "Medicine" && (
              <MedicineConsultDetails visitData={selectedVisit} />
            )}
            {selectedVisit.type === "OB-GYN" && (
              <OBConsultDetails visitData={selectedVisit} />
            )}
            {selectedVisit.type === "ENT" && (
              <EntConsultDetails visitData={selectedVisit} />
            )}
            {selectedVisit.type === "Opta" && (
              <OptaConsultDetails visitData={selectedVisit} />
            )}
            {selectedVisit.type === "Pedia" && (
              <PediaConsultDetails visitData={selectedVisit} />
            )}
            {selectedVisit.type === "Follow-up" && (
              <FollowupConsultDetails visitData={selectedVisit} />
            )}
            {selectedVisit.type === "Referral" && (
              <ReferralConsultDetails visitData={selectedVisit} />
            )}
          </div>
        )}
      </div>
